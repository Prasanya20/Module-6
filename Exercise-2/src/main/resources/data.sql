-- Full country list, extracted from the hands-on document (Hands on 5).
-- Runs automatically against the default H2 profile.
...
-- =====================================================================
-- Hands on 2 (doc 2): stock sample data.
-- The rows below are the exact example rows from the hands-on document
-- (FB Sept 2019, GOOGL open > 1250, FB highest-volume days, NFLX lowest
-- closing days) so the query methods can be demonstrated without needing
-- the full external stock-data.csv.
-- =====================================================================
...
-- Facebook, highest-volume days (outside September, for the "top 3 by volume" query)
...
-- Google, days with opening price greater than 1250
...
-- Netflix, lowest closing days (for the "top 3 lowest" query)
...
-- =====================================================================
-- Hands on 3-6 (doc 2): payroll sample data - department, skill, employee,
-- employee_skill. Column names follow the naming convention shown in the
-- hands-on document's example Hibernate-generated SQL (em_*, dp_*, es_*).
-- =====================================================================
...
INSERT INTO skill (sk_id, sk_name) VALUES (3, 'Excel');

INSERT INTO employee (em_id, em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) VALUES (1, 'Alice Johnson', 75000.00, true, '1990-04-12', 1);
INSERT INTO employee (em_id, em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) VALUES (2, 'Bob Smith', 68000.00, true, '1988-11-02', 1);
INSERT INTO employee (em_id, em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) VALUES (3, 'Carla Diaz', 54000.00, false, '1995-07-23', 2);
INSERT INTO employee (em_id, em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) VALUES (4, 'David Lee', 60000.00, true, '1992-01-30', 3);

-- Alice: Java + SQL. Bob: intentionally left without SQL, for testAddSkillToEmployee().
